...
search_kwargs = {"k": 1}
chatgpt = ChatOpenAI(openai_api_key=st.secrets["openai_api_key"], temperature=0, model="gpt-3.5-turbo-16k")
...
excl_prompt_template = """Use the following pieces of context to reformulate the text.
...
excl_chatgpt=OpenAI(openai_api_key=st.secrets["openai_api_key"], temperature=0, model="gpt-3.5-turbo-instruct")
